...
<div class="container " > 
    <div class="row content">
        <a  href="create-student-info.php"  class="button button-purple mt-12 pull-right">New Normal Registration</a> 
        <!-- <h3>Patient List</h3> -->
        <a  href="send-mail.php"  class="button button-purple mt-12" style="text-align: center; margin-left:50px;">Send File</a> 
